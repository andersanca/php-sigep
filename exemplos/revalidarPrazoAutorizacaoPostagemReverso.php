...
$result = $phpSigep->revalidarPrazoAutorizacaoPostagemReverso($accessDataParaAmbienteDeHomologacao->getCodAdministrativo(),'1041506559','10');

if (!$result->hasError()) {
    /** @var $buscaClienteResult \PhpSigep\Model\BuscaClienteResult */
    $pedidoReversoResult = $result->getResult();
    var_dump($pedidoReversoResult->getReturn());
}
